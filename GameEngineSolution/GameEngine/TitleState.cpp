...
#include "Game.h"
float blinKFrequency = 0.5; //hz
float period = 1 / blinKFrequency;
TitleState::TitleState() : bg1("img/title.png"), bg2("img/title2.png"), mainText("font/Call me maybe.ttf", 20, Text::TextStyle::BLENDED, "Pressione espaco para comecar", {0,0,0,255}), menuMusic("audio/Opening.wav") {
